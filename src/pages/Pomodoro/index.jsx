        ...
        <main className="flex items-center justify-center w-full h-screen text-white font-rubik font-medium">
            <div className="flex flex-col items-center">
                <div className="flex justify-between w-[24rem] text-xl">
                    ...
                    <button onClick={() => goToBreak("long_break")} className={`py-1 px-2 rounded-[0.3rem] text-black ${breakInfo.timerType == "long_break" ? "bg-[#84FF82]" : "text-white"}`} type="button">Long Break</button>
