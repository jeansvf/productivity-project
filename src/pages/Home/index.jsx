...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (currentDate != localDate || !localDate) {
            localStorage.setItem(
                "daily_pomodoro",
                JSON.stringify({date: currentDate, minutes: 0})
            )
            return
        }
    }, [])
    ...
    return (
        <div className="flex w-full min-h-screen justify-center -mb-[6rem] pt-24 bg-[#393939] z-10 text-white max-lg:pb-12 max-lg:flex-col max-lg:items-center">
            <div>
